...
void main() {
  ...
  testWidgets(
      "Will load the list of nests from this year and display them in a list",
  ...
  testWidgets(
      "Will load the list of nests from 2023 and display them in a list",
      (WidgetTester tester) async {
    await tester.pumpWidget(myApp);
    await tester.pumpAndSettle();
  ...
  testWidgets(
      "Will load the list of nests from 2022 and display them in a list",
      (WidgetTester tester) async {
    await tester.pumpWidget(myApp);
    await tester.pumpAndSettle();
    //find the filter button
  ...
  testWidgets("filter by min and max first egg age",
      (WidgetTester tester) async {
    await tester.pumpWidget(myApp);
    await tester.pumpAndSettle();
    //find the filter button
  ...
  testWidgets('Test if _downloadConfirmationDialog is shown',
      (WidgetTester tester) async {
  ...
  testWidgets("will color map icon by last modified date",
    ...
    expect(
        iconButton.style!.backgroundColor!.resolve({})!.toARGB32(), 4294967040);
    ...
    expect(iconButton2.style!.backgroundColor!.resolve({})!.toARGB32(),
        4278255360);
  });
}
